...
class Client(object):
    ...
    #function to add message to the TextArea
    def show_message(self, message):
        self.chat_ui.textBrowser.append(message)

    #actually connects to the server using this function
    ...
    def voice_message(self):
        ...
        voice_message = voice()
        self.chat_ui.textBrowser.append("Me: " + voice_message)
        print("sent: " + voice_message)

        try:
            self.tcp_client.send(voice_message.encode())
        except Exception as e:
